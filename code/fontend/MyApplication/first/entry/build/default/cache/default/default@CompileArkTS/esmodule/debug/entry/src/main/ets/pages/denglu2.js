...
class second extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.position({ x: "65%", y: 20 });
            Button.borderRadius(80);
            Button.width("20%");
            Button.height(30);
            Button.backgroundColor("#6D8B9E");
            if (!isInitialRender) {
                Button.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            TextInput.create({ placeholder: "年龄" });
            TextInput.width(230);
            TextInput.height(50);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            TextInput.create({ placeholder: "残障时间" });
            TextInput.width(230);
            TextInput.height(50);
            TextInput.backgroundColor("#6D8B9E");
            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            TextInput.create({ placeholder: "几节断离" });
            TextInput.width(230);
            TextInput.height(50);
            TextInput.backgroundColor("#6D8B9E");
            if (!isInitialRender) {
...
ViewStackProcessor.StopGetAccessRecording();
//# sourceMappingURL=denglu2.js.map