...
import { tabbar } from '@bundle:com.example.myapplication/entry/ets/pages/tabbar'; //下方导航栏
...
export class Index extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        super(parent, __localStorage, elmtId);
        this.__message = new ObservedPropertySimplePU('我的', this, "message");
        this.__index = new ObservedPropertySimplePU(0 //设置下方导航栏的顺序
        , this, "index");
        this.__textValue = new ObservedPropertySimplePU('', this, "textValue");
        this.__inputValue = new ObservedPropertySimplePU('昵称' //设置需要修改的初始值
        , this, "inputValue");
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            //2.2.1.1.1 信息横着分两块，头像和姓名等信息
            Row.backgroundImage({ "id": 16777256, "type": 20000, params: [], "bundleName": "com.example.myapplication", "moduleName": "entry" });
            if (!isInitialRender) {
                //2.2.1.1.1 信息横着分两块，头像和姓名等信息
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            //头像
            Image.shadow({ radius: 20, color: 0xCFD8DC, offsetX: 20, offsetY: 0 });
            if (!isInitialRender) {
                //头像
                Image.pop();
            }
